...
namespace Zhouyi.Job
{
    public static unsafe class Zhouyi_GNB
    {
        ...
        public static void OnDraw(Plugin plugin)
        {
            ...
            if (ImGui.Checkbox("开启##GNB", ref isstarted))
            {
            ...
            if (ImGui.SliderInt("转圈人数阈值##ZhuanquanThreshold", ref zhuanquanThreshold, 1, 10)) // 限制范围为1到10
            {
            ...
            if (ImGui.SliderInt("应急防御血量阈值##FangyuThreshold", ref fangyuThreshold, 0, 100))
            {
